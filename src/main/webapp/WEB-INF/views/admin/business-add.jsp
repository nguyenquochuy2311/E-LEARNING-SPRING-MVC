...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="${pageContext.request.contextPath }/resources/admin/image/png" sizes="16x16" href="images/favicon.png">
									...
									<div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group ">
												...
												<input type="file" name="uploadfile" accept=".jpg,.jpeg,.png" class="form-control" required>
											</div>
										</div>
