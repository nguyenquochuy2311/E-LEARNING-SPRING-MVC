								...
								<div class="card">
									<div class="text-center p-3 overlay-box" style="background-image: url(${pageContext.request.contextPath}/resources/admin/images/big/img1.jpg);">
										<div class="profile-photo">
											<img src="${pageContext.request.contextPath}/resources/admin/images/avatar/${admin.image}" width="100" class="img-fluid rounded-circle" alt="">
										</div>
										<h3 class="mt-3 mb-1 text-white">${admin.firstName}</h3>
										<p class="text-white mb-0">${admin.lastName}</p>
									</div>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>${admin.firstName}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>${admin.email}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>${admin.address}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
											...
											<div id="my-posts" class="tab-pane fade">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="${pageContext.request.contextPath}/resources/admin/images/profile/8.jpg" alt="" class="img-fluid">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="${pageContext.request.contextPath}/resources/admin/images/profile/9.jpg" alt="" class="img-fluid">
                                                        <a class="post-title" href="javascript:void()">
                                                            <h4>Collection of textile samples lay spread</h4>
                                                        </a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
...
<!-- Mirrored from edumin.dexignlab.com/xhtml/staff-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Jun 2021 02:22:26 GMT -->
</html>