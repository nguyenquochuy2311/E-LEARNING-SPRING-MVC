				...
				<div class="row page-titles mx-0">
					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="javascript:void(0);">All Student</a></li>
						</ol>
					</div>
				</div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="add-student.html" class="btn btn-primary">+ Add
											new</a>
									</div>
									<div class="card-body">
													...
													<c:forEach items="${list}" var="item">
														...
														<tr>
															<td><img class="rounded-circle" width="35"
																...
																alt=""></td>
															<td><a
																href="${pageContext.request.contextPath}/admin/detailstudent?id=${item.id}"><strong>${item.lastName}</strong></a>
															</td>
															...
															<td><a
																href="${pageContext.request.contextPath}/admin/editstudent?id=${item.id}"
																class="btn btn-sm btn-primary"><i
																	class="la la-pencil"></i></a> <a
																href="${pageContext.request.contextPath}/admin/deletestudent?id=${item.id}"
