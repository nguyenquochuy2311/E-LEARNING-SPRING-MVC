		...
		<div class="content-body">
			...
			<div class="container-fluid">
				...
				<div class="row page-titles mx-0">
					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="javascript:void(0);">Check Book</a></li>
						</ol>
					</div>
				</div>
				...
				<div class="row">
								...
								<c:forEach items="${booklist}" var="item">
									<tr>
										<td><img class="rounded-circle" width="50"
											src="${pageContext.request.contextPath}/resources/upload/images/books/${item.image}"
											alt=""></td>
										<td>${ item.title}</td>
										<td>${ item.des}</td>
							...
							<tbody>
								...
								<c:forEach items="${course}" var="item">
									<tr >
										...
										<td style="padding: 33px">${ item.title}</td>
					...
					<div class="col-xl-1 col-xxl-3 col-lg-3">
						<table class="table">
							<thead>
								<tr>
									<th>Accept</th>
							...
							<tbody>
								<c:forEach items="${booklist}" var="item">
									<tr>
										<td style="text-align: center;padding: 33px"><a
											href="${pageContext.request.contextPath}/admin/book-yes?id=${item.id}"><i
					...
					<div class="col-xl-1 col-xxl-3 col-lg-3">
						<table class="table">
							...
							<tbody>
								<c:forEach items="${booklist}" var="item">
									<tr>
										<td style="text-align: center;padding: 33px"><a href="${pageContext.request.contextPath}/admin/book-delete?id=${item.id}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
