					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="${pageContext.request.contextPath}/admin/all-instructor">Instructor</a></li>
							<li class="breadcrumb-item active"><a
								href="javascript:void(0);">Instructor Profile</a></li>
						</ol>
					</div>
				</div>
							...
							<div class="col-lg-12">
								<div class="card">
									<div class="text-center p-3 overlay-box"
										style="background-image: url(${pageContext.request.contextPath}/resources/upload/adminupload/${detailTeacher.image});">
																...
																<div class="card-body">
																	...
																	<ul class="list-group mb-3 list-group-flush">
																		...
																		<li
																			...
																			<span class="mb-0">Instructor :</span><strong>${detailTeacher.firstName}</strong>
