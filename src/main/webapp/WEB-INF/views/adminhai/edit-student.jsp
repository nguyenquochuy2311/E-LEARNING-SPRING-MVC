                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="edit-professor.html">Intructor</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Intructor</a></li>
                        </ol>
                    </div>
                </div>
                                ...
                                <form action="${pageContext.request.contextPath}/admin/editstudent" method="post">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">First Name</label>
												<input type="text" class="form-control" value="${teacher.firstName}" name="firstName">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="${teacher.phoneNumber}" name="phoneNumber">
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group fallback w-100">
												<img class="rounded-circle" width="35"
													src="${pageContext.request.contextPath}/resources/upload/images/students
													/${teacher.image}"
													alt="">
											</div>
										</div>
