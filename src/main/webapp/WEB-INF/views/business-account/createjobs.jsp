			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 text-left">
						<h1 style="font-weight: bold; font-size: 200%;">CREATE JOBS</h1>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="course-description" style="margin: 20px;">
						...
						<div class="edit-profile">
							...
							<form role="form" action="new" method="POST">
								...
								<div class="form-group">
									<label style="color: black;">Careers group</label> 
									<select
								...
								<div class="form-group">
									...
									<textarea name="requirement" type="text" class="form-control"></textarea>
								</div>
