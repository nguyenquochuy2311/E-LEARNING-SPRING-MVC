<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="${pageContext.request.contextPath }/resources/main/js/jquery.min.js.pagespeed.jm.iDyG3vc4gw.js"></script>
  <script src="${pageContext.request.contextPath }/resources/main/js/bootstrap.min.js%2bretina.js%2bwow.js.pagespeed.jc.pMrMbVAe_E.js"></script>
  ...
  <script src="${pageContext.request.contextPath }/resources/main/js/carousel.js%2bcustom.js.pagespeed.jc.nVhk-UfDsv.js"></script>
  <script>eval(mod_pagespeed_6Ja02QZq$f);</script>
  <script>eval(mod_pagespeed_KxQMf5X6rF);</script>
  <script src="${pageContext.request.contextPath }/resources/main/rs-plugin/js/jquery.themepunch.tools.min.js.pagespeed.jm.0PLSBOOLZa.js"></script>
  <script src="${pageContext.request.contextPath }/resources/main/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath }/resources/main/js/bxslider.js.pagespeed.jm.X-sF7YFq4Y.js"></script>
  <script
